...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/fenelon/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/fenelon/oh-my-zsh/master/tools/install.sh -O -)"
```
